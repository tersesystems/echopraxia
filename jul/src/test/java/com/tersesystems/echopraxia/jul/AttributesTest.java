...
public class AttributesTest extends TestBase {
    ...
    void testInstant() {
        ...
        JULCoreLogger coreLogger = new JULCoreLogger(Logger.FQCN, julLogger).withFieldConverter(converter);
    ...
    static class MyFieldBuilder implements FieldBuilder {
        ...
        public Field instant(String name, Instant value) {
           return Field.keyValue(name, Value.string(value.toString())).withAttribute(INSTANT_ATTR_KEY.bindValue(true));
        }
