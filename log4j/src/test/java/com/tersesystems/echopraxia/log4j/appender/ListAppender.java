package com.tersesystems.echopraxia.log4j.appender;
...
// Copied from logging-log4j
// https://github.com/apache/logging-log4j2/blob/release-2.x/log4j-core/src/test/java/org/apache/logging/log4j/test/appender/ListAppender.java
@Plugin(
    name = "List",
...
public class ListAppender extends AbstractAppender {
  ...
  public static class Builder implements org.apache.logging.log4j.core.util.Builder<ListAppender> {
    ...
    @PluginBuilderAttribute @Required private String name;

    @PluginBuilderAttribute private boolean entryPerNewLine;

    @PluginBuilderAttribute private boolean raw;
