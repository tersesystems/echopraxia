...
trait FieldBuilder extends Field.Builder {
  ...
  def keyValue[V: ToValue](key: String, value: V): Field =
    KeyValueField.create(key, ToValue[V].toValue(value))
  ...
  def onlyKeyValue[V: ToValue](tuple: (String, V)): java.util.List[Field] = only(
  ...
  def value[V: ToValue](key: String, value: V): Field =
    ValueField.create(key, ToValue[V].toValue(value))
  def value[V: ToValue](tuple: (String, V)): Field = value(tuple._1, tuple._2)
  def onlyValue[V: ToValue](key: String, value: V): java.util.List[Field] = only(
    this.value(key, value)
  )
  def onlyValue[V: ToValue](tuple: (String, V)): java.util.List[Field] = only(
    value(tuple._1, tuple._2)
  )
  ...
  def onlyArray[AV: ToArrayValue](name: String, value: AV): java.util.List[Field] = only(
    array(name, value)
  )
  def onlyArray[AV: ToArrayValue](tuple: (String, AV)): util.List[Field] = only(
  ...
  def onlyObj[OV: ToObjectValue](name: String, value: OV): java.util.List[Field] = only(
    obj(name, value)
  )
  def onlyObj[OV: ToObjectValue](tuple: (String, OV)): java.util.List[Field] =
    onlyObj(tuple._1, tuple._2)
