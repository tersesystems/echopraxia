...
trait LowPriorityToFieldBuilderResult {
  implicit val iterableToFieldBuilderResult: ToFieldBuilderResult[Iterable[Field]] = new ToFieldBuilderResult[Iterable[Field]] {
    override def toResult(iterable: Iterable[Field]): FieldBuilderResult = FieldBuilderResult.list(iterable.toArray)
  }

  implicit val iteratorToFieldBuilderResult: ToFieldBuilderResult[Iterator[Field]] = new ToFieldBuilderResult[Iterator[Field]] {
    import scala.collection.JavaConverters.asJavaIteratorConverter
    override def toResult(iterator: Iterator[Field]): FieldBuilderResult = FieldBuilderResult.list(iterator.asJava)
  }
  ...
  implicit val arrayToFieldBuilderResult: ToFieldBuilderResult[Array[Field]] = new ToFieldBuilderResult[Array[Field]] {
    override def toResult(array: Array[Field]): FieldBuilderResult = FieldBuilderResult.list(array)
  }
}

object ToFieldBuilderResult extends LowPriorityToFieldBuilderResult {
  def apply[T: ToFieldBuilderResult](input: T): FieldBuilderResult = implicitly[ToFieldBuilderResult[T]].toResult(input)
}